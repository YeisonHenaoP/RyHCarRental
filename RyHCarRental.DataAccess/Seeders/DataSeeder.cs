    ...
    public static class DataSeeder
    {
        public static async Task SeedAsync(ApplicationDbContext context)
        {
            ...
            var branches = new List<Branch>
            {
                ...
                new() { Name = "Sucursal Medellín Aeropuerto", Address = "Av. Las Vegas #92-30",   City = "Medellín",     Phone = "6042345678" },
            ...
            var vehicles = new List<Vehicle>
            {
                ...
                new() { Model = "Kia Picanto",      Plate = "ECO-003", Year = 2023, DailyRate = 78_000m,  Status = VehicleStatus.Available,     VehicleTypeId = vehicleTypes[0].Id, BranchId = branches[4].Id },
                ...
                new() { Model = "Hyundai Tucson",   Plate = "SUV-022", Year = 2023, DailyRate = 180_000m, Status = VehicleStatus.Available,     VehicleTypeId = vehicleTypes[2].Id, BranchId = branches[5].Id },
            ...
            var rental1 = new Rental
            {
                ...
                TotalCost = vehicles[3].DailyRate * 4,  // 4 días × $110.000 = $440.000
            ...
            // Arriendo 2: Carlos arrienda el Tracker — Activo
            var rental2 = new Rental
            {
                CustomerId = customers[1].Id,
                StartDate = new DateTime(2026, 6, 1),
                EndDate = new DateTime(2026, 6, 6),
                TotalCost = vehicles[6].DailyRate * 5,  // 5 días × $170.000 = $850.000
            ...
            context.RentalDetails.Add(new RentalDetail
            {
                ...
                SubTotal = 0,                           // Cancelado → sin costo
            });
            await context.SaveChangesAsync();
        }
    }
